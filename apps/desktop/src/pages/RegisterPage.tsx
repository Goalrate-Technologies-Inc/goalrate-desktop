 ...
 *
 * Hosted browser account creation with an option to continue locally.
 */
          ...
          <CardHeader className="space-y-4 pb-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="text-base">
                Create your GoalRate account in the browser
              </CardDescription>
            </div>
          ...
          <CardContent className="space-y-6">
            ...
            {waitingForBrowser && (
              <p className="text-center text-sm text-muted-foreground">
                Complete account creation in your browser to continue.
              </p>
            )}
            ...
            <p className="text-center text-xs text-muted-foreground">
              Free local usage does not require sign-in.
            </p>
